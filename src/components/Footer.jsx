const Footer = () => {
	return (
		<footer className="bg-brown-light">
			<div className="container wrapper pt-5">
				<div className="socials col-span-full">
			...
			<div className="footer-bottom bg-brown-dark py-3 mt-5">
				<div className="container wrapper text-center text-white">
					<p className="col-span-full">
						&copy; {new Date().getFullYear()} Drama Nexus
					</p>
				</div>
			</div>
		</footer>
